    ...
    render() {
        return (h("div", { class: 'app-results' }, h("div", { class: "resultInfoGrid" }, h("div", null, h("div", { class: "title" }, "Results:"), h("div", { class: "subTitle" }, 'Search: ' + this.search), h("div", { class: "subTitle" }, 'Type: ' + this.typeName), h("div", { style: { marginBottom: '10px' }, class: "subTitle" }, 'Page: ' + this.page + " of " + this.maxPage)), h("div", { onClick: () => this.returnToSearch(), class: "button" }, "Edit Search")), this.loading
            ...
            : h("div", null, this.results && this.results.totalResults && this.results.totalResults != 0
                ? h("div", null, h("div", { class: "container" }, this.results.Search.map((item) => h("div", { class: "resultGrid", style: { gridTemplateColumns: (item.Poster == "N/A" ? '1fr' : '1fr 100px') } }, h("div", null, h("div", { style: { marginBottom: '3px', fontSize: '20px', fontWeight: 'bold' } }, item.Title), h("div", { style: { marginBottom: '3px' } }, item.Year), h("a", { href: "https://imdb.com/title/" + item.imdbID }, "IMDB profile")), h("div", { style: { display: (item.Poster == "N/A" ? 'none' : '') } }, h("img", { onClick: () => this.goToPoster(item.Poster), class: "poster", src: item.Poster }))))), h("div", { class: "pageControl" }, h("div", { style: { gridArea: '1/ 2/ span 1/ span 1', margin: 'auto' }, onClick: (this.page > this.minPage) ? (() => this.substractPage()) : null }, h("i", { style: { opacity: ((this.page > this.minPage) ? "1" : '.3') }, class: "arrow left" })), h("div", { style: { gridArea: '1/ 3/ span 1/ span 1' }, class: "pageInfo" }, this.page + " of " + this.maxPage), h("div", { style: { gridArea: '1/ 4/ span 1/ span 1', margin: 'auto' }, onClick: (this.page < this.maxPage) ? (() => this.addPage()) : null }, h("i", { style: { opacity: ((this.page < this.maxPage) ? "1" : '.3') }, class: "arrow right" }))))
